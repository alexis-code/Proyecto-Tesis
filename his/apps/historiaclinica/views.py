    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            context = {
                ...
                'nro_area':2,
                'logohospital': '{}{}'.format(base.STATIC_URL, 'baseapp/assets/img/logo_hospital.png'),
                'logogobernacion': '{}{}'.format(base.STATIC_URL, 'baseapp/assets/img/logo-gobernacion.png'),
